...
public class CalendarUser implements Serializable {
	...
	/**
	 * Gets the email address for this user. When authenticating against this data
	 * directly, this is also used as the username.
	 *
	 * @return
	 */
	 ...
	 * formatter may be more appropriate, but in this application simplicity is more
	 * important.
	 *
	 * @return
	 */
