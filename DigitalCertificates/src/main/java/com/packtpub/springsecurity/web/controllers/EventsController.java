...
import com.packtpub.springsecurity.domain.CreateEventForm;
...
public class EventsController {
	...
	/**
	 * Populates the form for creating an event with valid information. Useful so
	 * that users do not have to think when filling out the form for testing.
	 *
