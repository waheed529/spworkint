...
public interface CalendarService {
	 ...
	 *
	 * @param id the {@link CalendarUser#getId()} of the {@link CalendarUser} to
	 *           find.
	 * @return a {@link CalendarUser} for the given id. Cannot be null.
	 * @throws EmptyResultDataAccessException if the {@link CalendarUser} cannot be
	 *                                        found
	 */
	 ...
	 *
	 * @param email the email address to use to find a {@link CalendarUser}. Cannot
	 *              be null.
	 * @return a {@link CalendarUser} for the given email or null if one could not
	 *         be found.
	 ...
	 * {@code partialEmail}.
	 *
	 * @param partialEmail the email address to use to find {@link CalendarUser}s.
	 *                     Cannot be null or empty String.
	 * @return a List of {@link CalendarUser}s that have an email that starts with
	 *         given partialEmail. The returned value will never be null. If no
	 *         results are found an empty List will be returned.
	 ...
	 *
	 * @param user the new {@link CalendarUser} to create. The
	 ...
	 *
	 * @param message the {@link Event} to create. Note that the
	 ...
	 * @return a non-null {@link List} of {@link Event}'s intended for the specified
	 *         {@link CalendarUser}. If the {@link CalendarUser} does not exist an
